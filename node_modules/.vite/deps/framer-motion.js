...
function keyframes({ duration = 300, keyframes: keyframeValues, times, ease: ease2 = "easeInOut" }) {
  const easingFunctions = isEasingArray(ease2) ? ease2.map(easingDefinitionToFunction) : easingDefinitionToFunction(ease2) || easeInOut;
  const state = {
    done: false,
...
function useVisualElement(Component3, visualState, props, createVisualElement2, ProjectionNodeConstructor, isSVG) {
  ...
  useIsomorphicLayoutEffect(() => {
    var _a2;
    if (!hasMountedOnce.current || !visualElement)
      return;
    (_a2 = visualElement.animationState) == null ? void 0 : _a2.animateChanges();
...
var VisualElementDragControls = class {
  ...
  scalePositionWithinConstraints() {
    ...
    eachAxis((axis) => {
      const axisValue = this.getAxisMotionValue(axis);
      if (!shouldDrag(axis, drag2, null) || !axisValue.get())
        return;
